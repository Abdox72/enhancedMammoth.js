...
function BodyReader(options) {
    ...
    function readParagraphProperties(element) {
        return readParagraphStyle(element).map(function(style) {
            return {
                ...
                backgroundColor: docxColors.readShading(element, theme),
                isRightToLeft: bidi.readParagraphRightToLeft(element)
            };
        });
    }
    ...
    function readRunProperties(element) {
        return readRunStyle(element).map(function(style) {
            ...
            var underline = docxColors.readUnderline(element.first("w:u"), theme);
            ...
            return {
                ...
                color: docxColors.readColor(element, theme),
                backgroundColor: docxColors.readShading(element, theme),
                rightToLeft: bidi.readRunRightToLeft(element)
            };
        });
    }
    ...
    function readTableCell(element) {
        return readXmlElements(element.children).map(function(children) {
            ...
            var cell = documents.TableCell(children, {
                colSpan: colSpan,
                backgroundColor: docxColors.readShading(properties, theme)
            });
